...
def generic_train(
    ...
    **extra_train_kwargs,
    ...
    if hasattr(args, "weights_summary"):
        del args.weights_summary

    all_cbs = [logging_callback] + extra_callbacks + [InitCallback()] + [checkpoint_callback]
    if hasattr(args, "callbacks") and args.callbacks:
        all_cbs += args.callbacks
